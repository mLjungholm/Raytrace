...
receptor_inds = zeros(6,6,6);
receptor_inds(1,5,4) = 1;
receptor_inds(3,4,4) = 1;
receptor_inds(4,4,3) = 1;
receptor_inds(6,3,2) = 1;
% tic
% for i = 1:10000
path = voxel_trace([-1 -1 -1],[1 1 1],0.4, start, dir, 1);
% end
% toc
